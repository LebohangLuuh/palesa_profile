...
document.addEventListener('DOMContentLoaded', function() {
  ...
  let index1 = 0;
  const targetElement1 = document.getElementById('text-1');
  
  function typeText1() {
    if (index1 < text1.length) {
      targetElement1.textContent += text1.charAt(index1);
      index1++;
...
function startText2() {
  ...
  let index2 = 0;
  const targetElement2 = document.getElementById('text-2');
  
  function typeText2() {
    if (index2 < text2.length) {
      targetElement2.textContent += text2.charAt(index2);
      index2++;
...
function startText3() {
  ...
  let index3 = 0;
  const targetElement3 = document.getElementById('text-3');
  
  function typeText3() {
    if (index3 < text3.length) {
      targetElement3.textContent += text3.charAt(index3);
      index3++;
...
// Start text2 and text3 after a delay
setTimeout(startText2, 2000);
setTimeout(startText3, 2000);
